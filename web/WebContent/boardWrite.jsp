            ...
            <form method="post" action="" enctype="multipart/form-data">
                <table class="table project-list-table table-nowrap align-middle table-borderless">
                    ...
                    <tbody>
                        <tr>
                            <td>Title</td>
                            <td><input type="text" maxlength="50" name="boardTitle" placeholder="글 제목을 입력하세요."></td>
                        </tr>
                        <tr>
                            <td>Content</td>
                            <td><textarea maxlength="2048" name="boardContent" placeholder="글 내용을 입력하세요."></textarea></td>
                        </tr>
                        <tr>
                            <td>File</td>
                            <td colspan="2">
